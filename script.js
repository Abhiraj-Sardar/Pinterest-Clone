...
function handleSearchFunctionality(){
    ...
    .addEventListener("blur", function(){
        document.querySelector(".overlay").style.display = "none"; //when you click outside of the input box. this will remove the overlay div 
        // document.querySelector(".searchdata").style.display = "none";
    })

    input
    .addEventListener("input", function(){ //this function will envoke when someone write in the input box
